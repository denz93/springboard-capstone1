...
class CreateGoalInputSchema(Schema):
  ...
  start_date = fields.DateTime(required=True, format='timestamp')
  end_date = fields.DateTime(required=True, format='timestamp')
...
class UpdateGoalInputSchema(Schema):
  ...
  start_date = fields.DateTime(format='timestamp')
  end_date = fields.DateTime(format='timestamp')
